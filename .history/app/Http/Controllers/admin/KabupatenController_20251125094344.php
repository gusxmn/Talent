...
class KabupatenController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.reference.kabupaten.create', compact('provinces', 'regencies'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.reference.kabupaten.edit', compact('regency', 'provinces', 'regencies'));
    }
