...
class KecamatanController extends Controller
{
    ...
    public function create()
    {
        ...
        // Group kabupatens by province for JavaScript - convert to use provinsi_id
        $kabupatensGrouped = $kabupatens->groupBy('provinsi_id')->map(function($items) {
            return $items->map(function($item) {
                return ['id' => $item->id, 'nama' => $item->nama_kabupaten];
            })->values();
        });

        return view('admin.reference.kecamatan.create', compact('kabupatens', 'kabupatensGrouped', 'provinces'));
    }
    ...
    public function edit(string $id)
    {
        ...
        // Group kabupatens by province for JavaScript
        $kabupatensGrouped = $kabupatens->groupBy('province_id')->map(function($items) {
            return $items->map(function($item) {
                return ['id' => $item->id, 'nama' => $item->nama_kabupaten];
            })->values();
        });

        return view('admin.reference.kecamatan.edit', compact('kecamatan', 'kabupatens', 'kabupatensGrouped', 'provinces'));
    }
