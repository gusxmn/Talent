...
/*
|--------------------------------------------------------------------------
| API Routes untuk Reference Location Selector
|--------------------------------------------------------------------------
*/
Route::prefix('api/reference')->group(function () {
    Route::get('/kabupaten/by-province', [\App\Http\Controllers\Api\LocationApiController::class, 'getKabupatenByProvince']);
    Route::get('/kecamatan/by-kabupaten', [\App\Http\Controllers\Api\LocationApiController::class, 'getKecamatanByKabupaten']);
    Route::get('/desa/by-kecamatan', [\App\Http\Controllers\Api\LocationApiController::class, 'getDesaByKecamatan']);
});
