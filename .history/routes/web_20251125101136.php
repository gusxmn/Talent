...
Route::get('/api/magang/villages/{districtId}', [MagangController::class, 'getVillages'])->name('magang.api.villages');
    ...
    // API endpoints untuk reference (cascading locations)
    Route::get('/api/reference/provinsi/list', [LocationApiController::class, 'getProvinsiList'])->name('api.reference.provinsi.list');
    Route::get('/api/reference/kabupaten/by-province', [LocationApiController::class, 'getKabupatenByProvince'])->name('api.reference.kabupaten.by-province');
    Route::get('/api/reference/kecamatan/by-kabupaten', [LocationApiController::class, 'getKecamatanByKabupaten'])->name('api.reference.kecamatan.by-kabupaten');
    Route::get('/api/reference/desa/by-kecamatan', [LocationApiController::class, 'getDesaByKecamatan'])->name('api.reference.desa.by-kecamatan');
