...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* PERBAIKAN: Dark Mode Toggle Button - alignment lebih baik */
    .dark-toggle {
    ...
    /* PERBAIKAN: Notification Button - alignment lebih baik */
    .notification-btn {
        background: rgba(0, 0, 0, 0.05);
        border: none;
        color: #555;
...
<body>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      // Notification functions (sama seperti sebelumnya)
      async function loadNotifications() {
        // ... (notification code tetap sama)
      }
