                    ...
                    <tbody>
                        @forelse($desas as $index => $desa)
                            <tr class="align-middle"> 
                                ...
                                <td class="col-kode">{{ $desa->id }}</td>
                                <td class="col-kecamatan">{{ $desa->kecamatan->nama_kecamatan ?? 'N/A' }}</td>
...
<script>
    ...
    document.getElementById('deleteForm').addEventListener('submit', function(e) {
        // Form akan submit dengan method DELETE via @method directive
    });
