...
<div class="judul-form-area text-white p-3" style="background-color: #28a745;">
    <label class="form-label mb-0 fw-bold">Tambah Desa/Kelurahan</label>
</div>
...
<div class="form-isian-area p-4" style="background-color: #e9ecef;">
    ...
    <div class="p-4 rounded shadow-sm" style="background-color: #cccccc;">
        <div class="mb-3 d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Form Tambah Desa/Kelurahan</h5>
        ...
        <form action="{{ route('admin.reference.desa.store') }}" method="POST">
            ...
            <!-- Lokasi Section -->
            <div class="mb-4 p-3 border rounded" style="background-color: #e0e0e0;">
                <label class="fw-bold mb-3">Lokasi <span class="text-danger">*</span></label>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('kode_desa') is-invalid @enderror" 
                           ...
                           value="{{ old('kode_desa') }}" 
                           placeholder="Contoh: 1107010001" required>
                    @error('kode_desa')
                ...
                <div class="col-md-6 mb-3">
                    <label for="nama_desa" class="form-label">Nama Desa/Kelurahan <span class="text-danger">*</span></label>
                    <input type="text" class="form-control @error('nama_desa') is-invalid @enderror" 
                           id="nama_desa" name="nama_desa" 
                           value="{{ old('nama_desa') }}" 
                           placeholder="Contoh: Paya Penyu" required>
                    @error('nama_desa')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                        ...
                        <option value="1" {{ old('status') == '1' || old('status') === true || old('status') === 1 ? 'selected' : '' }}>Aktif</option>
                        <option value="0" {{ old('status') == '0' || old('status') === false || old('status') === 0 ? 'selected' : '' }}>Nonaktif</option>
                    </select>
                    @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
