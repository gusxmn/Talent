...
<style>
    ...
    /* TABLE TEXT - CLEAN DISPLAY */
    .col-kode, .col-kabupaten, .col-provinsi {
                    ...
                    <tbody>
                        @forelse($kecamatans as $index => $kecamatan)
                            <tr class="align-middle"> 
                                ...
                                <td class="col-kode"><small>{{ $kecamatan->kode_kecamatan }}</small></td>
                                <td class="col-nama">{{ ucfirst(strtolower($kecamatan->nama_kecamatan)) }}</td>
                                <td class="col-kabupaten"><small>{{ ucfirst(strtolower($kecamatan->kabupaten->nama_kabupaten ?? '-')) }}</small></td>
                                <td class="col-provinsi"><small>{{ ucfirst(strtolower($kecamatan->kabupaten->provinsi->nama_provinsi ?? '-')) }}</small></td>
                                <td class="col-status">
                                    @if($kecamatan->status)
                                        <span class="badge bg-success"><small>Aktif</small></span>
                                    @else
                                        <span class="badge bg-secondary"><small>Nonaktif</small></span>
                                    @endif
                                </td>
