            ...
            <div class="tbl-content">
                <table class="table table-hover"> 
                    <tbody>
                            ...
                            <tr class="align-middle"> 
                                ...
                                <td class="col-actions">
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="{{ route('admin.reference.kecamatan.edit', $district->id) }}" title="Edit"
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center text-muted py-3" style="font-size: 11px !important;">Tidak ada data kecamatan</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
