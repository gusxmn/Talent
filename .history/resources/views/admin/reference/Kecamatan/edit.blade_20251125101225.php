        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body p-0">
                    <div id="kecamatan-list-container" style="max-height: 600px; overflow-y: auto;">
...
<script>
        ...
        try {
            ...
            if (data.length === 0) {
                listContainer.innerHTML = `
                    <div style="padding: 3rem 1rem; text-align: center; color: #6c757d;">
                        <i class="fas fa-inbox fa-2x mb-3" style="display: block;"></i>
                        <p>Belum ada data Kecamatan untuk kabupaten/kota ini</p>
                    </div>
                `;
                return;
            }
            ...
            let html = '';
            data.forEach(item => {
                const isCurrentItem = item.id === currentKecamatanId;
                html += `
    ...
    // Trigger auto-load list saat halaman sudah punya kabupaten value
