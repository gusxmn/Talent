        ...
        <form action="{{ route('admin.reference.kecamatan.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select id="provinsi" class="form-select" required disabled>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select id="kabupaten" class="form-select" name="kabupaten_id" required>
                        ...
                        @foreach ($kabupatens as $kabupaten)
                            <option value="{{ $kabupaten->id }}" data-province-id="{{ $kabupaten->province_id }}" {{ old('kabupaten_id') == $kabupaten->id ? 'selected' : '' }}>
    ...
    function initializeProvinces() {
        ...
        options.forEach(option => {
            ...
            if (provinceId && !provinces[provinceId]) {
                ...
                // Get province name from kabupaten relationship
