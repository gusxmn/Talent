                ...
                <div class="card-body p-0">
                    <div style="max-height: 600px; overflow-y: auto;" id="kecamatan-list-container">
                        @forelse($kecamatans ?? [] as $kec)
                            <div style="padding: 0.75rem 1rem; border-bottom: 1px solid #e9ecef; cursor: pointer; transition: background-color 0.2s; {{ $kec->id == $kecamatan->id ? 'background-color: #fff3cd;' : '' }}" 
                                 class="{{ $kec->id == $kecamatan->id ? 'active' : '' }}"
                                 onmouseover="if (this.className !== 'active') this.style.backgroundColor='#f8f9fa'" onmouseout="this.style.backgroundColor='{{ $kec->id == $kecamatan->id ? '#fff3cd' : 'white' }}'">
