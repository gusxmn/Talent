                ...
                <div class="card-body p-0">
                    <div style="max-height: 600px; overflow-y: auto;">
                        @forelse($provinces ?? [] as $prov)
                            @php
                                $isCurrentRow = $prov->id == $province->id;
                                $bgColor = $isCurrentRow ? '#fff3cd' : 'white';
                            @endphp
                            <div style="padding: 0.75rem 1rem; border-bottom: 1px solid #e9ecef; cursor: pointer; transition: background-color 0.2s; background-color: {{ $bgColor }};" 
                                 onmouseover="this.style.backgroundColor='#f8f9fa'" onmouseout="this.style.backgroundColor='{{ $bgColor }}'">
