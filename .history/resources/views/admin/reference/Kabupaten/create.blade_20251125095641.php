        ...
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body p-0">
                    <div style="max-height: 600px; overflow-y: auto;" id="kabupaten-list-container">
                        @forelse($regencies ?? [] as $regency)
                            <div style="padding: 0.75rem 1rem; border-bottom: 1px solid #e9ecef; cursor: pointer; transition: background-color 0.2s;" 
                                ...
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        <div class="fw-bold">{{ $regency->name }}</div>
                                        <small class="text-muted">Kode: <code>{{ $regency->id }}</code></small>
                                    </div>
                                    <span class="badge {{ $regency->status == 1 ? 'bg-success' : 'bg-secondary' }}">
                                        {{ $regency->status == 1 ? 'Aktif' : 'Nonaktif' }}
                                    </span>
                                </div>
                            </div>
                        @empty
