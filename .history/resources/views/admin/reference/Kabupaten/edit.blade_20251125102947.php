    ...
    <div class="p-4 rounded shadow-sm" style="background-color: #cccccc;">
        ...
        <form action="{{ route('admin.reference.kabupaten.update', $regency->id) }}" method="POST">
            ...
            <div class="mb-3 p-3 border rounded" style="background-color: #e0e0e0;">
                ...
                <input type="hidden" name="province_id" id="province_id" value="{{ old('province_id', $regency->province_id) }}">
                <input type="hidden" name="kabupaten_id" id="regency_id" value="{{ old('kabupaten_id', $regency->id) }}">
            ...
            <div class="d-flex gap-2 justify-content-end">
                <a href="{{ route('admin.reference.kabupaten.index') }}" class="btn btn-secondary">
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', function() {
        const provinceId = '{{ old("province_id", $regency->province_id) }}';
        if (provinceId) {
