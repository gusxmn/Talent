            ...
            <div class="card-body">
                ...
                <form id="campusForm" action="{{ route('campus.register.step2') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" id="namaKampus" name="nama_kampus" class="form-control" placeholder="Masukkan nama kampus/sekolah anda" value="{{ old('nama_kampus') }}" required>
                    </div>
                    
                    <div class="form-group">
                        <div class="custom-select-wrapper" id="jumlahMahasiswaWrapper">
                            <select class="custom-select" id="jumlahMahasiswa" name="jumlah_pegawai" required>
                    ...
                    <div class="form-group">
                        <div class="custom-select-wrapper" id="jenisInstitusiWrapper">
                            <select class="custom-select" id="jenisInstitusi" name="jenis_institusi" required>
