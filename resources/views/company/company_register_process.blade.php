            ...
            <div class="card-body">
                ...
                <form id="companyForm" action="{{ route('company.register.step2') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" id="namaPerusahaan" name="nama_perusahaan" class="form-control @error('nama_perusahaan') is-invalid @enderror" placeholder="Masukkan nama perusahaan anda" value="{{ old('nama_perusahaan') }}" required>
                    ...
                    <div class="form-group">
                        <div class="custom-select-wrapper" id="jumlahKaryawanWrapper">
                            <select class="custom-select @error('jumlah_karyawan') is-invalid @enderror" id="jumlahKaryawan" name="jumlah_karyawan" required>
                    ...
                    <div class="form-group">
                        <div class="custom-select-wrapper" id="industriWrapper">
                            <select class="custom-select @error('industri') is-invalid @enderror" id="industri" name="industri" required>
            ...
            logoInput.addEventListener('change', function(event) {
                ...
                if (file) {
                    ...
                    if (!validTypes.includes(file.type)) {
                        alert('Hanya file gambar (JPEG, PNG, JPG, GIF) yang diizinkan');
                        logoInput.value = '';
                        return;
                    }
